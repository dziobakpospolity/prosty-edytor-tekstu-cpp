...
void __fastcall TForm1::WyodrebnijString()
{
		...
		StatusBar1->Panels->Items[1]->Text = "Słów: "+ IntToStr(ls2 + la2 -2);
		StatusBar1->Panels->Items[2]->Text = "Zdań: "+IntToStr(lz2 - 1);
	...
	StatusBar3->Panels->Items[9]->Text = "20 i więcej liter: " + IntToStr(tabSlow[20]);
}
...
{
 int i, dl;
 // najpierw zainicjujmy tablicę wyników
 for (i = 1; i< max_n_znakow; i++)
 TablicaWynikowa[i] = 0;
 // następnie policzmy odpowiednie słowa
